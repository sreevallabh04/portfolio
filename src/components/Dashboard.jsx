        ...
        <div className="absolute bottom-[10%] md:bottom-[15%] left-[4%] md:left-[5%] max-w-xl lg:max-w-2xl z-10">
          ...
          {isRecruiter && (
            <div className="flex flex-wrap gap-4">
              <Button onClick={() => window.open('https://drive.google.com/file/d/1DJE0ej-MDp_XpGsW5xa6QpCQG42zsSRG/view', '_blank')} className="bg-white text-black px-6 py-3 text-lg font-semibold rounded-md hover:bg-gray-200 transition-colors duration-200">
                Resume
              </Button>
